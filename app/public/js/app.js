...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var notification_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! notification-js */ "./node_modules/notification-js/src/notification.js");
/* harmony import */ var notification_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(notification_js__WEBPACK_IMPORTED_MODULE_0__);
...
(function ($) {
  $(document).on('click', '#clipboard-copy-button', function (e) {
    ...
    notification_js__WEBPACK_IMPORTED_MODULE_0___default().notify('success', 'Copied');
  });
  ...
  $('#generate-button').on('click', function (e) {
    var userid = $('#userid').val();
    axios__WEBPACK_IMPORTED_MODULE_1___default().post("/user/".concat(userid, "/link-generate")).then(function (response) {
      // open modal
      $('#copy-field').val(response.data.link);
      var linkModal = new bootstrap__WEBPACK_IMPORTED_MODULE_2__.Modal(document.getElementById('link-modal'));
      linkModal.show();
    })["catch"](function (error) {
      notification_js__WEBPACK_IMPORTED_MODULE_0___default().notify('error', 'Error occured');
    });
  ...
  $('#register-form').on('submit', function (e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1___default().post('/user', Object.fromEntries(formData)).then(function (response) {
      // open modal
      $('#copy-field').val(response.data.link);
      var linkModal = new bootstrap__WEBPACK_IMPORTED_MODULE_2__.Modal(document.getElementById('link-modal'));
      linkModal.show();
      ...
      if (error.response.data.errors !== undefined) {
        for (var _i = 0, _Object$entries = Object.entries(error.response.data.errors); _i < _Object$entries.length; _i++) {
          ...
          notification_js__WEBPACK_IMPORTED_MODULE_0___default().notify('error', message);
        }
      } else {
        notification_js__WEBPACK_IMPORTED_MODULE_0___default().notify('error', 'Error occured');
      }
...
/***/ "./node_modules/notification-js/src/notification.js":
/*!**********************************************************!*\
  !*** ./node_modules/notification-js/src/notification.js ***!
  \**********************************************************/
